...
async fn check_media(
    ...
    let mut dec_cmd = vec_strings!["-hide_banner", "-nostats", "-threads", "6", "-thread_queue_size", "512", "-hwaccel_device", "0", "-hwaccel", "cuvid", "-hwaccel_output_format", "cuda", "-v", "level+info"];
